...
?>							
					...
					<li class="nav-item mx-xl-1 mb-1 mb-xl-0">
						<div class="nav-link px-2 scroll_news" id="scroll_news"><b>最新消息</b></div>
					</li>
					<li class="nav-item mx-xl-1 mb-1 mb-xl-0">
						<div class="nav-link px-2 scroll_quick_search" id="scroll_quick_search"><b>快速查詢</b></div>
					</li>
					<li class="nav-item mx-xl-1 mb-1 mb-xl-0">
						<div class="nav-link px-2 scroll_leader_board" id="scroll_leader_board"><b>價格排行</b></div>
					</li>
		...
		<div class="row">
			...
			<div class="col-12 mb-4">
				<div class="dialog leaderboard">
					<?php
						$sql = "SELECT 		Number,Name,Picture,s_0,r_0,p_0,(s_0+r_0+p_0) as total
		...
		<div class="container">
			<div class="row row-cols-2 row-cols-sm-2 row-cols-lg-4 py-5">
				<div class="col px-2 px-sm-5 mb-3 mb-lg-0">
    				<ul class="list-unstyled row row-cols-2 row-cols-sm-4 mb-0 p-3 icon-list">
      					<li class="px-2 col text-center mb-4 mb-sm-0"><a class="text-muted" href="https://asia.pokemon-card.com/tw/"><svg class="bi" width="24" height="24"><use xlink:href="#pokemon"/></svg></a></li>
      					<li class="px-2 col text-center mb-4 mb-sm-0"><a class="text-muted" href="https://www.facebook.com/Pokemon.TCG.Official.Taiwan/"><svg class="bi" width="24" height="24"><use xlink:href="#facebook"/></svg></a></li>
      					<li class="px-2 col text-center mb-4 mb-sm-0"><a class="text-muted" href="https://www.youtube.com/channel/UCCI-s2RRbUVPUEKVCcgil_g"><svg class="bi" width="24" height="24"><use xlink:href="#youtube"/></svg></a></li>
      					<li class="px-2 col text-center mb-4 mb-sm-0"><a class="text-muted" href="https://www.tiktok.com/@pokemon?"><svg class="bi" width="24" height="24"><use xlink:href="#tiktok"/></svg></a></li>
    				</ul>
    			</div>
    			<div class="col px-2 px-sm-5 mb-3 mb-lg-0">
     			<h5>商場</h5>
      			...
      			<h5 class="px-3 px-sm-0">快速連結</h5>
      				<ul class="list-unstyled px-3 px-sm-0">
        				...
        				<li class="mb-2"><div class="btn p-0 scroll_news" id="scroll_news">最新消息</div></li>
        				<li class="mb-2"><div class="btn p-0 scroll_quick_search" id="scroll_quick_search">快速查詢</div></li>
        				<li class="mb-2"><div class="btn p-0 scroll_leader_board" id="scroll_leader_board">價格排行</div></li>
      				</ul>
    			</div>
       			<div class="col px-2 px-sm-5 mb-3 mb-lg-0">
      			<h5>聯繫我們</h5>
